...
{ id:'opposites-1', title:'Przeciwieństwa', level:'1-3', area:'słownictwo', type:'pairs',
  ...
  items:[
    // Uwaga przy dokładaniu par: żadne hasło nie może powtórzyć się w dwóch parach,
    // bo w memory dziecko dopasowałoby „long" do niewłaściwego „short".
    ['🐘 big','🐭 small'],['🔥 hot','🧊 cold'],['😀 happy','😢 sad'],['🔛 on','⭕ off'],
    ['🐇 fast','🐌 slow'],['📏 long','✂️ short'],['🚪 open','🔒 closed'],['☀️ day','🌙 night'],
    ['⬆️ up','⬇️ down'],['📥 in','📤 out'],['✅ yes','❌ no'],['👍 good','👎 bad'],
    ['🏔️ high','🕳️ low'],['🧼 clean','🧹 dirty'],['🍯 full','🕳️ empty'],['👶 young','👴 old'],
    ['🙂 easy','😤 difficult'],['📢 loud','🤫 quiet'],['💧 wet','🏜️ dry'],['💡 light','🌑 dark'],
    ['⬅️ left','➡️ right'],['🥇 first','🏁 last'],['📍 near','🔭 far'],['💰 rich','🪙 poor'],
    ['💪 strong','🪶 weak'],['📚 thick','📄 thin'],['🧸 soft','🪨 hard'],['⏩ front','⏪ back'],
    ['👦 boy','👧 girl'],['🪑 sit','🧍 stand'],
  ]},
...
{ id:'classroom-language-1', title:'Polecenia w klasie', level:'1-3', area:'gramatyka', type:'prompts',
  ...
  items:[
    ...
    {q:'✏️ Take your pencil.', a:'Weź ołówek.'},
    ...
    {q:'🗣️ Say your name.', a:'Powiedz swoje imię.'},
    {q:'🎨 Draw a cat.', a:'Narysuj kota.'},
    {q:'🖍️ Colour it blue.', a:'Pokoloruj na niebiesko.'},
